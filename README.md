...
| 2 | Dockerize services | Not Started | Containerize all services with Dockerfiles & Docker Compose |
| 3 | PostgreSQL + Redis + Queue | Not Started | State persistence, caching, and async messaging with RabbitMQ |
